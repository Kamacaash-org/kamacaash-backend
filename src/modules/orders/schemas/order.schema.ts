...
export class Order {
  ...
  @Prop({ type: Types.ObjectId, ref: 'SurplusPackage', required: true })
...
export const OrderSchema = new MongooseSchema({
  orderId: {
    type: String,
    unique: true,
    required: true,
  ...
  packageId: { type: Types.ObjectId, ref: 'SurplusPackage', required: true },
  completedBy: { type: Types.ObjectId, ref: 'staff' },
