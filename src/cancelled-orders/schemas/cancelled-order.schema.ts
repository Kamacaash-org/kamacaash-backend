...
export class CancelledOrder {
    ...
    @Prop({ type: MongooseSchema.Types.ObjectId, ref: 'SurplusPackage', required: true, index: true })
...
export const CancelledOrderSchema = SchemaFactory.createForClass(CancelledOrder);
